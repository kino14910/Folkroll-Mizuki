...
(function () {
	...
	const I18N = {
		'zh-CN': {
			...
			catFrontMatter: 'Front Matter',
			catBasicMd: '基础 Markdown',
			catExtended: '扩展功能',
			catMermaid: 'Mermaid 图表',
			catVideo: '视频嵌入',
			catTemplates: '文章模板',
			modBasicConfig: '基本配置',
			modEncryptConfig: '加密配置',
			modPinConfig: '置顶配置',
			modDraftConfig: '草稿配置',
			modH1: '一级标题',
			modH2: '二级标题',
			...
			modNote: 'Note 提示框',
			modTip: 'Tip 技巧框',
			modImportant: 'Important 重要框',
			modWarning: 'Warning 警告框',
			modCaution: 'Caution 注意框',
			modCustomAdmonition: '自定义标题提示框',
			modSpoiler: 'Spoiler 隐藏',
			modExcerpt: '摘要分隔',
			modInlineMath: '行内公式',
			modBlockMath: '块级公式',
			modFlowchart: '流程图',
		...
		'zh-TW': {
			...
			catFrontMatter: 'Front Matter',
			catBasicMd: '基礎 Markdown',
			catExtended: '擴充功能',
			catMermaid: 'Mermaid 圖表',
			catVideo: '影片嵌入',
			catTemplates: '文章模板',
			modBasicConfig: '基本設定',
			modEncryptConfig: '加密設定',
			modPinConfig: '置頂設定',
			modDraftConfig: '草稿設定',
			modH1: '一級標題',
			modH2: '二級標題',
			...
			modWarning: 'Warning 警告框',
			modCaution: 'Caution 注意框',
			modCustomAdmonition: '自訂標題提示框',
			modSpoiler: 'Spoiler 隱藏',
			modExcerpt: '摘要分隔',
			modInlineMath: '行內公式',
			modBlockMath: '區塊公式',
			modFlowchart: '流程圖',
		...
		en: {
			...
			catFrontMatter: 'Front Matter',
			catBasicMd: 'Basic Markdown',
			catExtended: 'Extended Features',
			catMermaid: 'Mermaid Diagrams',
			catVideo: 'Video Embed',
			catTemplates: 'Article Templates',
			modBasicConfig: 'Basic Config',
			modEncryptConfig: 'Encrypt Config',
			modPinConfig: 'Pin Config',
			modDraftConfig: 'Draft Config',
			modH1: 'Heading 1',
			modH2: 'Heading 2',
			modH3: 'Heading 3',
			modBold: 'Bold',
			modItalic: 'Italic',
			modStrike: 'Strikethrough',
			modUl: 'Bullet List',
			modOl: 'Numbered List',
			modTask: 'Task List',
			modQuote: 'Blockquote',
			modInlineCode: 'Inline Code',
			modCodeBlock: 'Code Block',
			modLink: 'Link',
			modImage: 'Image',
			modTable: 'Table',
			modHr: 'Horizontal Rule',
			modHtml: 'HTML Block',
			...
			modWarning: 'Warning',
			modCaution: 'Caution',
			modCustomAdmonition: 'Custom Admonition',
			modSpoiler: 'Spoiler',
			modExcerpt: 'Excerpt Separator',
			modInlineMath: 'Inline Math',
			modBlockMath: 'Block Math',
			modFlowchart: 'Flowchart',
			modSequence: 'Sequence',
			modGantt: 'Gantt',
			modClassDiag: 'Class Diagram',
			modPie: 'Pie Chart',
			modState: 'State Diagram',
			modYoutube: 'YouTube',
			modBilibili: 'Bilibili',
			modStdArticle: 'Standard Article',
			modEncArticle: 'Encrypted Article',
			modPinArticle: 'Pinned Announcement',
			modTutorial: 'Tech Tutorial',
		},
		ja: {
			...
			catFrontMatter: 'Front Matter',
			catBasicMd: '基本 Markdown',
			catExtended: '拡張機能',
			catMermaid: 'Mermaid 図表',
			catVideo: '動画埋め込み',
			catTemplates: '記事テンプレート',
			modBasicConfig: '基本設定',
			modEncryptConfig: '暗号化設定',
			modPinConfig: 'ピン留め設定',
			modDraftConfig: '下書き設定',
			modH1: '見出し1',
			modH2: '見出し2',
			modH3: '見出し3',
			modBold: '太字',
			...
			modTask: 'タスク',
			modQuote: '引用ブロック',
			modInlineCode: 'インラインコード',
			modCodeBlock: 'コードブロック',
			modLink: 'リンク',
			modImage: '画像',
			modTable: '表',
			modHr: '区切り線',
			...
			modNote: 'Note ノート',
			modTip: 'Tip ヒント',
			modImportant: 'Important 重要',
			modWarning: 'Warning 警告',
			modCaution: 'Caution 注意',
			modCustomAdmonition: 'カスタムタイトル',
			modSpoiler: 'Spoiler 隠す',
			modExcerpt: '抜粋区切り',
			modInlineMath: 'インライン数式',
			modBlockMath: 'ブロック数式',
			modFlowchart: 'フローチャート',
			modSequence: 'シーケンス図',
			modGantt: 'ガントチャート',
			modClassDiag: 'クラス図',
			modPie: '円グラフ',
			...
			modStdArticle: '標準記事',
			modEncArticle: '暗号化記事',
			modPinArticle: 'ピン留め公告',
			modTutorial: '技術チュートリアル',
		},
	}
	...
	const CODE_TRANSLATIONS = {
		...
		en: {
			...
			标签2: 'Tag2',
			分类名称: 'Category',
			加密文章: 'Encrypted Article',
			加密文章描述: 'Encrypted article description',
			加密: 'Encrypted',
			安全: 'Security',
			置顶文章: 'Pinned Article',
			置顶文章描述: 'Pinned article description',
			公告: 'Announcement',
			草稿文章: 'Draft Article',
			草稿: 'Draft',
			示例: 'Example',
			...
			未完成任务: 'Incomplete task',
			待办事项: 'Todo item',
			引用内容: 'Quoted content',
			引用第二段: 'Second paragraph',
			行内代码: 'inline code',
			代码内容: 'code here',
			代码: 'code',
			链接文本: 'Link text',
			...
			列3: 'Col 3',
			'用户名/仓库名': 'user/repo',
			提示信息内容: 'Note content here.',
			技巧和建议内容: 'Tip content here.',
			重要信息内容: 'Important content here.',
			警告内容: 'Warning content here.',
			注意事项内容: 'Caution content here.',
			自定义标题: 'Custom Title',
			带有自定义标题的提示框内容: 'Admonition content with custom title.',
			...
			视频BV号: 'VIDEO_BV_ID',
			文章主标题: 'Main Title',
			这里是文章开头部分: 'Introduction paragraph here.',
			二级标题: 'Section Title',
			'正文内容，支持': 'Body text with',
			三级标题: 'Subsection',
			文章总结部分: 'Summary section.',
			总结: 'Summary',
			加密内容: 'Encrypted Content',
			'这是一篇加密文章，只有输入正确密码才能查看':
				'This is an encrypted article. Enter the correct password to view.',
			敏感信息: 'Sensitive Info',
			这里包含需要保护的内容: 'Protected content here.',
			...
			请注意: 'Please note...',
			技术教程标题: 'Technical Tutorial Title',
			技术教程描述: 'Technical tutorial description',
			教程: 'Tutorial',
			技术: 'Tech',
			技术教程: 'Tech Tutorial',
			简介段落: 'Introduction paragraph.',
			基本概念: 'Basic Concepts',
		...
		ja: {
			...
			まとめ: 'まとめ',
			暗号化コンテンツ: '暗号化コンテンツ',
			'この記事は暗号化されています。正しいパスワードを入力してください。':
				'この記事は暗号化されています。正しいパスワードを入力してください。',
			機密情報: '機密情報',
			'保護が必要な内容です。': '保護が必要な内容です。',
			重要なお知らせ: '重要なお知らせ',
			重要な通知: '重要な通知',
			重要: '重要',
			日時: '日時',
			...
			重要なリマインダー: '重要なリマインダー',
			'ご注意ください...': 'ご注意ください...',
			技術チュートリアルタイトル: '技術チュートリアルタイトル',
			技術チュートリアルの説明: '技術チュートリアルの説明',
			チュートリアル: 'チュートリアル',
			技術: '技術',
			技術チュートリアル: '技術チュートリアル',
			'紹介文。': '紹介文。',
	...
	const MODULES = [
		{
			catKey: 'catFrontMatter',
			icon: '⚙️',
			items: [
				{
					nameKey: 'modBasicConfig',
					icon: '📋',
					code:
						'---\ntitle: "文章标题"\npublished: ' +
		...
		},
		{
			...
			items: [
				...
				},
				{
					nameKey: 'modLink',
					icon: '🔗',
					code: '[链接文本](https://example.com "标题")',
				},
				{
					nameKey: 'modImage',
					icon: '🖼',
					code: '![替代文本](./images/photo.png "图片标题")\n\n',
				},
				{
					nameKey: 'modTable',
					icon: '▦',
		...
		},
		{
			...
			items: [
				{
					nameKey: 'modGithubCard',
					icon: '🐙',
					code: ':::github{repo="用户名/仓库名"}\n\n',
				},
				{
					nameKey: 'modNote',
					icon: '💡',
			...
			items: [
				{
					nameKey: 'modYoutube',
					icon: '▶️',
					code: '<iframe width="100%" height="468" src="https://www.youtube.com/embed/视频ID" title="YouTube" frameborder="0" allowfullscreen></iframe>\n\n',
				},
				{
					nameKey: 'modBilibili',
					icon: '📺',
					code: '<iframe width="100%" height="468" src="//player.bilibili.com/player.html?bvid=视频BV号&p=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>\n\n',
				},
			],
		},
		{
	...
	document.addEventListener('click', (e) => {
		if (
			!e.target.closest('.theme-picker-btn') &&
		...
		if (hljsStyleLink) {
			hljsStyleLink.href =
				theme === 'light'
					...
					: 'https://cdn.jsdelivr.net/npm/highlight.js@11/styles/dark-plus.min.css'
		}
	...
	function renderModules(filter = '') {
		...
		MODULES.forEach((cat) => {
			...
			const items = cat.items.filter((i) => {
				...
				return (
					!f ||
					itemName.toLowerCase().includes(f) ||
					catName.toLowerCase().includes(f)
				)
			})
			if (!items.length) {
				return
	...
	$('#btnFrontMatter').onclick = () => {
		parseFMFromEditor()
		toggleModal('fmModal', true)
	}
	...
	function parseFMFromEditor() {
		...
		if ($('#fm-encrypted').checked) {
			$('#fm-password-row').classList.remove('hidden')
		}
	}
	...
	$('#fmApply').onclick = () => {
		...
		if ($('#fm-updated').value) {
			add('updated', $('#fm-updated').value)
		}
		addQ('description', $('#fm-description').value)
		if ($('#fm-image').value) {
			add('image', $('#fm-image').value)
		}
		if ($('#fm-tags').value) {
			const tags = $('#fm-tags')
				.value.split(',')
		...
		if ($('#fm-category').value) {
			add('category', $('#fm-category').value)
		}
		fm += `draft: ${$('#fm-draft').checked}\n`
		fm += `pinned: ${$('#fm-pinned').checked}\n`
		if ($('#fm-pinned').checked && $('#fm-priority').value) {
			add('priority', $('#fm-priority').value)
		}
		...
		if ($('#fm-alias').value) {
			addQ('alias', $('#fm-alias').value)
		}
		if ($('#fm-lang').value) {
			add('lang', $('#fm-lang').value)
		}
		if ($('#fm-license').value) {
			addQ('licenseName', $('#fm-license').value)
		}
		if ($('#fm-author').value) {
			addQ('author', $('#fm-author').value)
		}
		if ($('#fm-source').value) {
			addQ('sourceLink', $('#fm-source').value)
		}
		fm += '---\n\n'
	...
	$('#exportModal .modal-overlay').onclick = () =>
